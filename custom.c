...
static const char * artist_list[] = {
    "Novelty Christmas Group",
    "Billy McLaughlin"
    "Genshin Impact Main Theme Var",
};
...
void custom_init(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_img_src(guider_ui.screen_slider_1, &_icn_slider_15x15, LV_PART_KNOB);
    spectrum = spectrum_1;
...
static lv_obj_t * album_img_create(lv_obj_t * parent)
{
    ...
    switch(track_id) {
    case 2:
        lv_img_set_src(img, &_cover_3_105x105);
        spectrum = spectrum_3;
